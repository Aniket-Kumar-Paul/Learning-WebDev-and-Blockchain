...
describe("FundMe", async function() {
    ...
    describe("fund", async function() {
        ...
        it("Updated the amount funded data structure", async function() {
            ...
            const response = await fundMe.addressToAmountFunded(deployer) // get the amount funded using the deployer address
    ...
    describe("withdraw", async function() {
        ...
        it("Allows us to withdraw with multiple funders", async function() {
            ...
            await expect(fundMe.funders(0)).to.be.reverted // if all funders have been reset, then fundMe.funders(0) should give error, which will be reverted
