...
error RandomIpfsNft__NeedMoreETHToBeSent();
...
contract RandomIpfsNft is VRFConsumerBaseV2, ERC721URIStorage, Ownable {
    ...
    // We want the Pug to be super rare, shiba little less rare and St. Bernard very common
    ...
    // VRF Helpers
    mapping(uint256 => address) public s_requestIdToSender; // mapping b/w request Ids and the NFT owner
    ...
    function requestNft() public payable returns (uint256 requestId) {
        if (msg.value < i_mintFee) {
            revert RandomIpfsNft__NeedMoreETHToBeSent();
        }
    ...
    function getChanceArray() public pure returns (uint256[3] memory) {
        ...
        // index 1 has 20% chance of happening, (30 - 10)
        // index 2 has 60% chance of happening, (100 - (30+10))
