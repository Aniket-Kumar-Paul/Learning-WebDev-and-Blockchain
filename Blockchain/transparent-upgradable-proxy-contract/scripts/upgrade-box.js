...
async function main() {
    ...
    const upgradeTx = await BoxProxyAdmin.upgrade(transparentProxy.address, boxV2.address) // (from, to)
    await upgradeTx.wait(1)

    // we call all of our functions on transparentProxy.address, but proxyBox will have the abi of BoxV2
